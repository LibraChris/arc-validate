...
module isalight =
    ...
    let private checkForParam (expectedParam : CvTerm) (paramCollection : #seq<#IParam>) = 
        let tmp = 
    ...
    let runBaselineValidation (arcDir:string) =
        ...
        ARCExpect.Execute.ValidationPipeline(outDirResXml, outDirBadge,"BaseLineValidation") cases
        runSummery